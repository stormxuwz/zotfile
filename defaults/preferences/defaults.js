...
pref("extensions.zotfile.pdfExtraction.formatAnnotationHighlight", '<p><span style="background-color:%(color);">"%(content)"</span> (%(cite) <a href="%(uri_item)"> (See Zotero) </a></p>');
pref("extensions.zotfile.pdfExtraction.formatAnnotationUnderline", '<p style=font-size:120%><b>%(content)</b></p><br>');
